...
"use strict";var React=require("react"),Quiz=require("../.."),demoQuiz=require("./config/quiz"),quiz=React.createElement(Quiz,{shortUrl:window.context.shortUrl,siteUrl:window.context.siteUrl,quiz:demoQuiz,quizTitle:window.context.title});React.render(quiz,document.getElementById("horoscopeContainer"));
...
"use strict";var React=require("react"),Question=module.exports=React.createClass({displayName:"exports",propTypes:{result:React.PropTypes.number.isRequired,question:React.PropTypes.object.isRequired,selectAnswer:React.PropTypes.func.isRequired},selectAnswer:function(e){this.props.result||(this.props.selectAnswer(e),this.setState({checked:e}))},getInitialState:function(){return{checked:null}},render:function(){var e;e=this.props.question.answers.length%3===0?"threeUp":this.props.question.answers.length%2===0?"twoUp":"oneUp";var t=this.props.question.answers.map(function(t,s){return React.createElement("li",{key:s,onClick:this.selectAnswer.bind(null,s),className:this.state.checked===s?"selected "+e:e+""},React.createElement("img",{src:this.props.question.answers[s]}),React.createElement("input",{type:"checkbox",className:"questionAnswer",checked:this.state.checked===s}))}.bind(this));if(this.props.question.media.caption)var s=React.createElement("span",{className:"source"},React.createElement("span",{className:"credit"},this.props.question.media.caption));return React.createElement("div",{className:"quizQuestion"},React.createElement("h2",{className:"questionTitle"},this.props.question.prompt),React.createElement("img",{className:"questionImage",src:this.props.question.media.image,title:this.props.question.media.title,alt:this.props.question.media.altText}),s,React.createElement("ul",{className:"clearfix questionAnswers "+("number"==typeof this.state.checked?"answered ":"")},t))}});

},{"react":168}],10:[function(require,module,exports){
"use strict";var React=require("react"),QuestionList=require("./question-list"),_=require("lodash"),Result=require("./result"),results=require("../demo/src/config/result-text"),Quiz=module.exports=React.createClass({displayName:"exports",propTypes:{quiz:React.PropTypes.object.isRequired,shortUrlSlug:React.PropTypes.string.isRequired,quizTitle:React.PropTypes.string.isRequired,siteUrl:React.PropTypes.string.isRequired},getInitialState:function(){return{answers:[]}},selectOption:function(e,t){var s=_.clone(this.state.answers);s[e]=t,1===e&&this.setState({resultImageIndex:t}),this.setState({answers:s})},getResultIndex:function(){if(!(this.state.answers.length<this.props.quiz.questions.length)){var e=_.some(this.state.answers,function(e){return null==e}.bind(this));if(!e){var t=this.state.answers[0],s=this.state.answers[1],r=this.state.answers[2],i=t+2*s+24*r,n=new Date,u=n.getTime()/864e5,a=Math.round(i+u%results.length);return a}}},render:function(){var e=this.getResultIndex();return React.createElement("div",{id:"quiz",className:"horoscopeQuiz "+(null!=e?"completed":"")},React.createElement(QuestionList,{selectOption:this.selectOption,result:e,questions:this.props.quiz.questions}),null!=e?React.createElement(Result,{resultImageIndex:this.state.resultImageIndex,result:e,shortUrl:this.props.shortUrl,siteUrl:this.props.siteUrl,quizTitle:this.props.quizTitle}):null)}});

},{"../demo/src/config/result-text":3,"./question-list":8,"./result":11,"lodash":13,"react":168}],11:[function(require,module,exports){
"use strict";var React=require("react"),labels=require("./labels"),resultImages=require("../demo/src/config/result-images"),resultText=require("../demo/src/config/result-text"),Result=module.exports=React.createClass({displayName:"exports",propTypes:{result:React.PropTypes.number.isRequired,shortUrl:React.PropTypes.string.isRequired,quizTitle:React.PropTypes.string.isRequired,siteUrl:React.PropTypes.string.isRequired,resultImageIndex:React.PropTypes.number.isRequired},componentDidMount:function(){function e(e,t,s,r,a,l,i){if(e){var c=(new Date).getTime(),o=setInterval(function(){var n=Math.min(1,((new Date).getTime()-c)/l);i?e[t]=r+n*(a-r)+s:e.style[t]=r+n*(a-r)+s,1==n&&clearInterval(o)},25);e.style[t]=r+s}}var t=React.findDOMNode(this.refs.quizResult),s=/Firefox/i.test(navigator.userAgent);s?e(document.documentElement,"scrollTop","",document.documentElement.scrollTop,t.offsetTop,600,!0):e(document.body,"scrollTop","",document.body.scrollTop,t.offsetTop,600,!0)},facebookShare:function(){FB.ui({method:"feed",link:window.location.origin,name:labels.myResultIs+":"+labels.horoscopeResultTitle+"..."+this.props.quizTitle,description:this.props.result.text,picture:this.props.result.media.image},function(e){})},render:function(){var e="https://twitter.com/intent/tweet?",t=encodeURIComponent(labels.horoscopeResultTitle),s=encodeURIComponent(this.props.shortUrl),r="url="+s,a="&text="+labels.myResultIs+":"+t+".."+this.props.quizTitle,l="&via=kasra",i=e+r+a+l;if(resultImages[this.props.resultImageIndex].credit)var c=React.createElement("span",{className:"source"},React.createElement("span",{className:"credit"},resultImages[this.props.resultImageIndex].credit));return React.createElement("div",{id:"quizResult",className:"clearfix"},React.createElement("h1",{className:"quizTitle"},this.props.quizTitle),React.createElement("h2",{className:"resultTitle"},labels.horoscopeResultTitle),React.createElement("img",{className:"resultImage",src:resultImages[this.props.resultImageIndex].image}),c,React.createElement("p",{className:"resultText"},resultText[this.props.result]),React.createElement("div",{ref:"quizResult",className:"clearfix shareResult"},React.createElement("p",null,labels.shareWithYourFriends),React.createElement("a",{className:"facebookQuizShare facebook",onClick:this.facebookShare},React.createElement("i",{className:"icon-facebook-2"})),React.createElement("a",{href:i,className:"twitter twitterQuizShare"},React.createElement("i",{className:"icon-twitter-2"}))))}});
