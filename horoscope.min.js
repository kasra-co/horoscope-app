...
"use strict";var React=require("react"),Quiz=require("../.."),horoscope=require("./config/quiz"),quiz=React.createElement(Quiz,{shortUrl:window.context.shortUrl,siteUrl:window.context.siteUrl,quiz:horoscope,quizTitle:window.context.title});React.render(quiz,document.getElementById("horoscopeContainer"));
