...
"use strict";var React=require("react"),labels=require("./labels"),resultImages=require("../demo/src/config/result-images"),resultText=require("../demo/src/config/result-text"),Result=module.exports=React.createClass({displayName:"exports",propTypes:{result:React.PropTypes.number.isRequired,shortUrl:React.PropTypes.string.isRequired,quizTitle:React.PropTypes.string.isRequired,siteUrl:React.PropTypes.string.isRequired,resultImageIndex:React.PropTypes.number.isRequired},componentDidMount:function(){function e(e,t,s,r,a,l,i){if(e){var o=(new Date).getTime(),c=setInterval(function(){var n=Math.min(1,((new Date).getTime()-o)/l);i?e[t]=r+n*(a-r)+s:e.style[t]=r+n*(a-r)+s,1==n&&clearInterval(c)},25);e.style[t]=r+s}}var t=React.findDOMNode(this.refs.quizResult),s=/Firefox/i.test(navigator.userAgent);s?e(document.documentElement,"scrollTop","",document.documentElement.scrollTop,t.offsetTop,600,!0):e(document.body,"scrollTop","",document.body.scrollTop,t.offsetTop,600,!0)},facebookShare:function(){var e=window.context.pluginUrl+"node_modules/quiz"+resultImages[this.props.resultImageIndex].image;console.log(e),FB.ui({method:"feed",link:window.location.origin,name:labels.myResultIs,description:resultText[this.props.result],picture:e},function(e){})},render:function(){var e="https://twitter.com/intent/tweet?",t=(encodeURIComponent(labels.horoscopeResultTitle),encodeURIComponent(this.props.shortUrl)),s="url="+t,r="&text="+labels.myResultIs,a="&via=kasra",l=e+s+r+a;if(resultImages[this.props.resultImageIndex].credit)var i=React.createElement("span",{className:"source"},React.createElement("span",{className:"credit"},resultImages[this.props.resultImageIndex].credit));return React.createElement("div",{id:"quizResult",className:"clearfix"},React.createElement("h1",{className:"quizTitle"},this.props.quizTitle),React.createElement("h2",{className:"resultTitle"},labels.horoscopeResultTitle),React.createElement("img",{className:"resultImage",src:window.context.pluginUrl+"node_modules/quiz/"+resultImages[this.props.resultImageIndex].image}),i,React.createElement("p",{className:"resultText"},resultText[this.props.result]),React.createElement("div",{ref:"quizResult",className:"clearfix shareResult"},React.createElement("p",null,labels.shareWithYourFriends),React.createElement("a",{className:"facebookQuizShare facebook",onClick:this.facebookShare},React.createElement("i",{className:"icon-facebook-2"})),React.createElement("a",{href:l,className:"twitter twitterQuizShare"},React.createElement("i",{className:"icon-twitter-2"}))))}});
