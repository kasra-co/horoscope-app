	...
	render: function() {
			...
			return (
				<li
					...
					className={ this.state.checked === index? "selected " + quizColumns : ( quizColumns + "")  } >
						<img src={ this.props.imagePath + this.props.question.answers[index] }/>
		...
		return (
			<div className="quizQuestion">
				...
				<img className="questionImage" src={ this.props.imagePath + this.props.question.media.image } title={ this.props.question.media.title } alt={ this.props.question.media.altText } />
				{source}
