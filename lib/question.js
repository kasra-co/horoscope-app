	...
	render: function() {
			...
			return (
				<li
					...
					className={ this.state.checked === index? "selected " + quizColumns : ( quizColumns + "")  } >
						<img src={ window.context.pluginUrl + "node_modules/horoscopeQuiz" + this.props.question.answers[index] }/>
		...
		return (
			<div className="quizQuestion">
				...
				<img className="questionImage" src={ window.context.pluginUrl + "node_modules/horoscopeQuiz" + this.props.question.media.image } title={ this.props.question.media.title } alt={ this.props.question.media.altText } />
				{source}
