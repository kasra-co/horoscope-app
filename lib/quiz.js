...
var Quiz = module.exports =  React.createClass({
	...
	render: function() {
		...
		return (
			<div id="quiz" className={ result != null? "completed" : null }>
				<QuestionList selectOption={ this.selectOption } result={ result } questions={ this.props.quiz.questions } />
				{ result != null? <Result result={ result } shortUrlSlug={ this.props.shortUrlSlug } siteUrl={ this.props.siteUrl } quizTitle={ this.props.quizTitle } /> : null }
			</div>
		);
	}
