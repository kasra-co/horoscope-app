...
var Result = module.exports = React.createClass({
	...
	facebookShare: function () {
		var image = window.context.pluginUrl + "node_modules/quiz" + resultImages[ this.props.resultImageIndex ].image;
		console.log( image );
		FB.ui(
			{
				method: 'feed',
	...
	render: function() {
		...
		return (
			<div id="quizResult" className="clearfix">
				...
				<img className="resultImage" src={ window.context.pluginUrl + "node_modules/quiz/" + resultImages[ this.props.resultImageIndex ].image } />
				{ source }
