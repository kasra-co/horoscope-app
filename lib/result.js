		...
		FB.ui(
			{
				...
				name: labels.yourResultIs + ": " + this.props.result.title,
	...
	render: function() {
		...
		return (
			<div id="quizResult" className="clearfix">
				...
				<img className="resultImage" src={ this.props.result.media.image } title={ this.props.result.media.title } alt={ this.props.result.media.altText } />
				{ source }
